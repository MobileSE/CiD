...
def select_methods(SourceCodeFile, SourceCodeHideFile, FrameworkFilteredFile,
    ...
    # all_set_inter = set(pro1.keys()).intersection(set(pro2.keys()))

    # OnlyinSC = pkg1.keys() - pkg2.keys()
    # OnlyinFrame = pkg2.keys() - pkg1.keys()
    #
    # print("all pkgs: ", len(pkg1), len(pkg2), "only : ", len(OnlyinSC), len(OnlyinFrame))
    ...
    print("discarded APIs: ", len(remain1), len(remain2))
...
if __name__ == '__main__':
    ...
    # select
    select_methods(SourceCodeFile, SourceCodeHideFile, FrameworkFilteredFile,
                   SAVE_intersection, SAVE_source_selected, SAVE_framework_selected,
                   SAVE_SOURCECODE_discard, SAVE_FRAMEWORK_discard,
                   SAVE_SOUCECODE_PKG_discard, SAVE_FRAMEWORK_PKG_discard)
