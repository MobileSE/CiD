...
def select_fields(framework_30_discard, MiuiCodeFilterFile, FrameworkFilteredFile,
    ...
    print("discarded Fields: ", len(discard1), len(discard2))
...
if __name__ == '__main__':
    ...
    MiuiFrameworkFiltered = "fields-miui-30-filtered.txt"

    OfficialFrameworkFile = "official/framework-" + str(level) + "/fields.txt"
    OfficialFrameworkFilteredFile = "official/framework-" + str(level) + "/fields-filtered.txt"
    ...
    filter_fields(MiuiFramework, MiuiFrameworkFiltered)
    filter_fields(OfficialFrameworkFile, OfficialFrameworkFilteredFile)

    # select
    select_fields(framework_30_discard, MiuiFrameworkFiltered, OfficialFrameworkFilteredFile,
                  SAVE_intersection, SAVE_source_selected, SAVE_framework_selected,
                  SAVE_SOURCECODE_discard, SAVE_FRAMEWORK_discard,
                  SAVE_SOUCECODE_PKG_discard, SAVE_FRAMEWORK_PKG_discard)
